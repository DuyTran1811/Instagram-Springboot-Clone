...
import com.instagram.loginservice.payload.*;
...
public class UserControllers {
    ...
    public UserControllers(UserService userService, AuthenticationManager authenticationManager, JwtTokenProvider tokenProvider) {
